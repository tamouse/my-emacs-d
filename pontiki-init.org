   ...
   (quote
    (
     ...
     ("jp" "Process Journal Entry" entry
      (file+datetree+prompt (concat org-directory "process_journal.org"))
      "* %? %(org-set-property \"CAPTURE_DATE\" \"%U\")\n"
      :clock-in t
      :clock-resume t
      :empty-lines 1
     ...
     ("jl" "Link Journal Entry" entry
      (file+datetree+prompt (concat org-directory "link_journal.org"))
      "* %? %(org-set-property \"CAPTURE_DATE\" \"%U\")\n"
      :empty-lines 1
      )
     ("n" "note" entry
...
#+BEGIN_SRC emacs-lisp
  (use-package web-mode :ensure t
    ...
    (add-to-list 'auto-mode-alist '("\\.jsonb\\'" . web-mode))
    )
