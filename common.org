...
#+BEGIN_SRC emacs-lisp
  ...
  (setq
   org-agenda-files (list
		     ...
		     (concat (file-name-as-directory (expand-file-name org-directory)) "Tech")
		     (concat (file-name-as-directory (expand-file-name org-directory)) "reachlocal")
		     )
...
#+BEGIN_SRC emacs-lisp
   (setq
    ...
    (quote
     (
      ("b" "blog" entry
       (file+olp+datetree  org-blog-file)
	...
	:time-prompt 1
      ...
      ("w" "Default Org-protocol Capture Template" entry
       (file+olp+datetree  org-web-capture-file)
